	...
	<body>
		...
		<div id="show-login" class="content scaffold-show" role="main">
			...
			<ol class="property-list login">
				...
				<g:if test="${loginInstance?.password}">
				<li class="fieldcontain">
					<span id="password-label" class="property-label"><g:message code="login.password.label" default="Password" /></span>
					
						<span class="property-value" aria-labelledby="password-label"><g:fieldValue bean="${loginInstance}" field="password"/></span>
